-- ═══════════════════════════════════════════════════════════════════════
-- PrecisionFlow — Complete Database Setup
-- ═══════════════════════════════════════════════════════════════════════
--
-- Run this file in the Supabase SQL Editor (https://supabase.com/dashboard
-- → your project → SQL Editor → New query) to create all tables, indexes,
-- RLS policies, triggers, and seed data in a single step.
--
-- Alternatively, apply the individual migration files in supabase/migrations/
-- using the Supabase CLI:  supabase db push
--
-- Tables created:
--   1. users           — User profiles (extends auth.users)
--   2. clients         — Client companies
--   3. campaigns       — Campaigns (root entity)
--   4. briefs          — Campaign briefs (raw + AI-structured)
--   5. approvals       — Multi-stage approval workflows
--   6. audit_logs      — Immutable audit trail
--   7. campaign_members — Campaign team members
--   8. creators        — Influencer/creator profiles
--   9. campaign_shortlists — Creator shortlists per campaign
--  10. content_tasks   — Content tasks assigned to creators
--  11. content_artifacts — Content uploads with version control
-- ═══════════════════════════════════════════════════════════════════════
